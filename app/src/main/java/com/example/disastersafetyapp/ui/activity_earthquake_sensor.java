...
public class activity_earthquake_sensor extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_earthquake_sensor);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (avg >= 0.45) {
            ...
            Intent ii = new Intent(this.getApplicationContext(), activity_earthquake_steps.class);
